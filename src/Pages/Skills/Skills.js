    ...
    return (
        <div className=''>
            <div className="card flex-col lg:flex-row bg-base-100 ">
                <figure><img src={skills} alt="skills" className='w-96 rounded-xl mt-5 lg:mt-0' /></figure>
                <div className="card-body">
                    ...
                    <p className='flex gap-3 items-center'><FaEdit /><span><span className='font-bold'>Familiar:</span> <br /><span className='text-gray-400'>Next.js | JWT Token | Axios | Redux.</span> </span></p>
